...
public class SpaceConqueror {
	...
	if(t[pos].br!=1 && t[pos].r!=1 && t[pos+1].doubt_purple<1 && t[pos+1].doubt_red<1 && t[pos+1].purple!=1 && t[pos+1].red!=1 && !(t[pos].back.contains("r") && (t[pos].l!=1 || t[pos].u!=1 || t[pos].d!=1) && check(t[pos]) ))
	{
	////////////
	...
	score+=50;
	t[pos].purple=1;
	System.out.println("\n\nTrapped by purple enemy in cell position "+pos+".");
	TimeUnit.SECONDS.sleep(6);
	}
	...
	if(t[pos].env.contains("M(*)"))
	{
		score+=100;
		t[pos].red = 1;
		System.out.println("\n\nTrapped by red enemy in cell position "+pos+".");
		TimeUnit.SECONDS.sleep(6);
	}
